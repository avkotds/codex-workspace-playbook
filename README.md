...
A public, beginner-friendly guide to connecting projects, durable knowledge, a Workspace Manager, separate Codex threads, and sub-agents.
...
The site uses the OpenAI Sites vinext starter. Use the existing lockfile and Node.js 22.13 or newer.
